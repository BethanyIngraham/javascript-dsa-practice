 ...
 * 
 * Assumptions:
 *  - There will not be any negative number values
 *  - All string combinations are read from left to right
 *  - Most numeral values are read from biggest numbers to smallest
 *  - Exceptions remain for 6 cases of subtraction
 *  - Convert string roman numeral to integer value
 *
 * Approach:
